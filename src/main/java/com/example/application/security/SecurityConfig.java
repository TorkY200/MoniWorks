...
public class SecurityConfig {
  ...
  public SecurityConfig(
      CompanyPermissionEvaluator permissionEvaluator, AuditLogoutHandler auditLogoutHandler) {
  ...
  SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    ...
    http.logout(logout -> logout.addLogoutHandler(auditLogoutHandler).logoutSuccessUrl("/login"));
