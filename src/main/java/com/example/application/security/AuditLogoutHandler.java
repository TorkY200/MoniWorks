...
/**
 * Handles logout events by logging them to the audit trail before the session is destroyed. This
 * provides visibility into logout activity for security monitoring and compliance.
 */
@Component
