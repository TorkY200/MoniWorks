...
/**
 * Listens for Spring Security authentication events and logs them to the audit trail. This provides
 * visibility into login activity for security monitoring and compliance.
 */
@Component
public class AuthenticationEventListener {
  ...
  /**
   * Handles successful authentication events. Logs the login to the audit trail with the user's
   * email.
   */
  @EventListener
  ...
  /** Handles authentication failure events. Logs failed login attempts for security monitoring. */
  @EventListener
