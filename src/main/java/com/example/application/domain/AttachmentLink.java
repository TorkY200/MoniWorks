...
/**
 * Links an attachment to an entity (transaction, invoice, bill, product, contact). Allows one
 * attachment to be linked to multiple entities and one entity to have multiple attachments.
 */
@Entity
@Table(
