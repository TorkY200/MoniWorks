 ...
 *
 * <p>Each line corresponds to a reporting box (e.g., Box 5 for total sales, Box 6 for zero-rated
 * sales, Box 9 for total GST collected, etc.)
 *
 * <p>NZ GST Return boxes (IR-03): - Box 5: Total sales and income - Box 6: Zero-rated supplies -
 * Box 7: Total purchases and expenses - Box 8: Credit adjustments - Box 9: Debit adjustments - Box
 * 10: GST collected (output tax) - Box 11: GST paid (input tax) - Box 12: Tax payable/refund
 */
@Entity
