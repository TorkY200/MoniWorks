...
/**
 * Represents a recurring transaction template. Stores the template configuration for generating
 * recurring transactions, invoices, or bills on a schedule.
 */
@Entity
@Table(
    ...
    indexes = {
      ...
      @Index(
          name = "idx_recurring_template_next_run",
          columnList = "company_id, status, next_run_date")
    })
  ...
  public String getScheduleDescription() {
    String freq =
        switch (frequency) {
          ...
          case WEEKLY ->
              frequencyInterval == 1 ? "Weekly" : "Every " + frequencyInterval + " weeks";
          case FORTNIGHTLY -> "Fortnightly";
          case MONTHLY ->
              frequencyInterval == 1 ? "Monthly" : "Every " + frequencyInterval + " months";
          case QUARTERLY -> "Quarterly";
          case YEARLY ->
              frequencyInterval == 1 ? "Yearly" : "Every " + frequencyInterval + " years";
        };
