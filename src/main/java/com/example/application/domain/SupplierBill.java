...
@Table(
    name = "supplier_bill",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"company_id", "bill_number"})})
public class SupplierBill {
  ...
  public SupplierBill(
      Company company, String billNumber, Contact contact, LocalDate billDate, LocalDate dueDate) {
