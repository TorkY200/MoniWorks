...
/**
 * Represents an audit trail entry for tracking all significant changes.
 * Audit events are immutable - they can only be created, never modified or deleted.
 */
@Entity
...
public class AuditEvent {
    ...
    public AuditEvent(Company company, User actor, String eventType,
