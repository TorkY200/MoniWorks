...
/**
 * Represents a customer or supplier contact in the system.
 * Contacts are company-scoped and can be customers, suppliers, or both.
 * Used for invoicing, bill payments, and tracking business relationships.
 */
@Entity
