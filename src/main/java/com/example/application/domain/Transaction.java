...
/**
 * Represents a financial transaction (payment, receipt, journal, transfer).
 * Transactions contain lines that debit/credit accounts.
 * Posted transactions are immutable - corrections require reversals.
 */
@Entity
...
public class Transaction {
    ...
    public enum TransactionType {
        PAYMENT, RECEIPT, JOURNAL, TRANSFER
    }
