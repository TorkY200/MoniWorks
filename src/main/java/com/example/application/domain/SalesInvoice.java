...
/**
 * Represents a sales invoice or credit note issued to a customer. Invoices follow a workflow: DRAFT
 * → ISSUED → VOID Issuing an invoice creates ledger entries (AR debit, Income credit, Tax). Credit
 * notes are created against original invoices with reversed entries. Voiding is done via
 * reversal/credit note patterns.
 */
@Entity
@Table(
    name = "sales_invoice",
