...
/**
 * Represents an invitation for a user to join a company. Invitations contain a secure token that
 * allows the recipient to set up their account (for new users) or accept membership (for existing
 * users).
 */
@Entity
@Table(
