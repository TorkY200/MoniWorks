...
/**
 * Represents a batch payment run for paying multiple supplier bills. Payment runs go through: DRAFT
 * → COMPLETED workflow. DRAFT: Bills selected, can be edited COMPLETED: Payments posted to ledger,
