...
/**
 * PDF template settings stored in Company.settingsJson. Configures branding, layout, and content
 * for generated PDFs (invoices, statements, remittance advices, reports).
 */
