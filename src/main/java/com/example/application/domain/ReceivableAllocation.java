...
/**
 * Tracks allocation of receipt transactions to sales invoices. Supports partial payments (one
 * receipt split across multiple invoices) and overpayments (allocated amount exceeds invoice
 * balance - creates credit).
 */
@Entity
