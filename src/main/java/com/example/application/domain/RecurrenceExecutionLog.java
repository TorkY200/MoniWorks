...
/**
 * Logs each execution of a recurring template. Tracks success/failure and maintains audit trail of
 * generated entities.
 */
@Entity
@Table(
    name = "recurrence_execution_log",
    indexes = {
...
public class RecurrenceExecutionLog {
  ...
  public static RecurrenceExecutionLog success(
      RecurringTemplate template, Long createdEntityId, RecurringTemplate.TemplateType entityType) {
