...
/**
 * Represents a saved grid view configuration per user per entity type.
 * Allows users to customise and persist grid columns, filters, and sorting.
 * Supports the SavedView(id, companyId, userId, entityType, name, columnsJson, filtersJson, sortJson) domain model.
 */
@Entity
@Table(name = "saved_view", uniqueConstraints = {
