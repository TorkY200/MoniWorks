...
/**
 * Tracks allocation of payment transactions to supplier bills. Supports partial payments (one
 * payment split across multiple bills) and overpayments (allocated amount exceeds bill balance -
 * creates credit).
 */
@Entity
