...
/**
 * Represents a calculated tax amount for a ledger entry. Each posted transaction line with a tax
 * code generates a TaxLine that records the taxable amount and calculated tax.
 *
 * <p>TaxLines are used for: - GST/VAT return generation - Tax reporting by box mapping - Audit
 * trail of tax calculations
 */
@Entity
@Table(
    name = "tax_line",
