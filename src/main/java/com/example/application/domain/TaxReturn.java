 ...
 *
 * <p>A tax return is a snapshot of tax calculations for a date range, containing box totals that
 * can be reported to tax authorities.
 *
 * <p>Features: - Generated from TaxLine data for the period - Supports cash or invoice/accrual
 * basis - Stores totals by report box - Immutable once finalized (corrections via new returns)
 */
@Entity
@Table(
    name = "tax_return",
    indexes = {
      @Index(
          name = "idx_tax_return_company_period",
