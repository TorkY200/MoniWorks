...
/**
 * Represents an allocation rule for auto-suggesting coding during bank reconciliation.
 * Rules match bank feed item descriptions to suggest accounts and tax codes.
 */
@Entity
@Table(name = "allocation_rule", indexes = {
...
public class AllocationRule {
    ...
    public AllocationRule(Company company, String ruleName, String matchExpression,
    ...
    /**
     * Tests if the given description matches this rule's expression.
     * Currently supports simple CONTAINS matching.
     */
