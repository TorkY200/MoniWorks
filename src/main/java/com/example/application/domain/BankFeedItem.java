...
/**
 * Represents a single line item from an imported bank statement.
 * Bank feed items can be matched to existing transactions or used to create new ones.
 */
@Entity
@Table(name = "bank_feed_item", indexes = {
...
public class BankFeedItem {
    ...
    public BankFeedItem(BankStatementImport bankStatementImport, LocalDate postedDate,
