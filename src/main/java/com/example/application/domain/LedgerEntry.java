...
/**
 * Represents an immutable ledger entry created when a transaction is posted.
 * These entries form the official record of all accounting activity.
 * Ledger entries cannot be modified - corrections require reversals.
 */
@Entity
