 ...
 * All significant actions in the system are logged for accountability.
 */
@Service
@Transactional
public class AuditService {
     ...
     */
    public AuditEvent logEvent(Company company, User actor, String eventType,
    ...
    public AuditEvent logLogin(User user) {
        return logEvent(null, user, "USER_LOGIN", "User", user.getId(),
    ...
    public AuditEvent logLogout(User user) {
        return logEvent(null, user, "USER_LOGOUT", "User", user.getId(),
    ...
    @Transactional(readOnly = true)
    public List<AuditEvent> findByCompanyAndDateRange(Company company,
