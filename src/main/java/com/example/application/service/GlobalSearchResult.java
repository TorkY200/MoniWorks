...
/**
 * Unified search result DTO for global search across all entity types.
 * Provides a consistent structure for displaying search results regardless of entity type.
 */
public record GlobalSearchResult(
     ...
     */
    public static GlobalSearchResult fromTransaction(Long id, String type, String description,
            String reference, LocalDate date, BigDecimal amount, String status) {
     ...
     */
    public static GlobalSearchResult fromContact(Long id, String code, String name,
            String type, String email, boolean active) {
        return new GlobalSearchResult(
            EntityType.CONTACT,
            id,
            code + " - " + name,
     ...
     */
    public static GlobalSearchResult fromProduct(Long id, String code, String name,
            String category, BigDecimal sellPrice, boolean active) {
        return new GlobalSearchResult(
            EntityType.PRODUCT,
            id,
            code + " - " + name,
     ...
     */
    public static GlobalSearchResult fromAccount(Long id, String code, String name,
     ...
     */
    public static GlobalSearchResult fromSalesInvoice(Long id, String invoiceNumber,
            String contactName, LocalDate issueDate, BigDecimal total, String status) {
        return new GlobalSearchResult(
     ...
     */
    public static GlobalSearchResult fromSupplierBill(Long id, String billNumber,
            String contactName, LocalDate billDate, BigDecimal total, String status) {
        return new GlobalSearchResult(
