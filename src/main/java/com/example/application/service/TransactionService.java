...
public class TransactionService {
  ...
  public Transaction addLine(
      Transaction transaction,
      Account account,
      BigDecimal amount,
      TransactionLine.Direction direction) {
  ...
  @Transactional(readOnly = true)
  public List<Transaction> findByCompanyAndDateRange(
  ...
  @Transactional(readOnly = true)
  public List<Transaction> findPostedByCompanyAndDateRange(
      Company company, LocalDate startDate, LocalDate endDate) {
  ...
  /**
   * Calculates the balance of the transaction (debits - credits). A balanced transaction should
   * return zero.
   */
  @Transactional(readOnly = true)
