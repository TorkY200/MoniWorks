...
/**
 * Service for managing departments (cost centres).
...
public class DepartmentService {
    ...
    public Department createDepartment(Company company, String code, String name, User actor) {
        ...
        auditService.logEvent(company, actor, "DEPARTMENT_CREATE", "Department",
            department.getId(), "Created department: " + code + " - " + name);
    ...
    public Department save(Department department, User actor) {
        ...
        if (!isNew) {
            auditService.logEvent(department.getCompany(), actor, "DEPARTMENT_UPDATE",
    ...
    public void deactivate(Department department, User actor) {
        ...
        auditService.logEvent(department.getCompany(), actor, "DEPARTMENT_DEACTIVATE",
    ...
    public void activate(Department department, User actor) {
        ...
        auditService.logEvent(department.getCompany(), actor, "DEPARTMENT_ACTIVATE",
            "Department", department.getId(),
