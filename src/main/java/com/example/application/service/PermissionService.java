...
/**
 * Service for managing permissions. Permissions are typically seeded via database migration and
...
public class PermissionService {
  ...
  /**
   * Creates a new permission if it doesn't already exist. This is used during initialization to
