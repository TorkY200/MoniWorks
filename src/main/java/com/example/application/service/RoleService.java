...
public class RoleService {
  ...
  public Role createCompanyRole(
      Company company, String name, String description, Set<String> permissionNames) {
    ...
    auditService.logEvent(
        company, null, "ROLE_CREATED", "Role", saved.getId(), "Created role: " + name);
  ...
  /** Deletes a company-specific role. System roles cannot be deleted. */
