...
public interface ProductRepository extends JpaRepository<Product, Long> {
  ...
  @Query(
      "SELECT p FROM Product p WHERE p.company = :company AND "
  ...
  @Query(
      "SELECT DISTINCT p.category FROM Product p WHERE p.company = :company AND p.category IS NOT NULL ORDER BY p.category")
