...
class SalesInvoiceServiceTest {
  ...
  @Mock private SalesInvoiceLineRepository lineRepository;
  ...
  void setUp() {
    ...
    SalesInvoiceLine line =
        new SalesInvoiceLine(incomeAccount, BigDecimal.valueOf(2), BigDecimal.valueOf(100));
    line.setId(1L);
  ...
  void issueCreditNote_ExceedsBalance_ThrowsException() {
    ...
    IllegalStateException exception =
        assertThrows(
            IllegalStateException.class, () -> invoiceService.issueCreditNote(creditNote, user));
